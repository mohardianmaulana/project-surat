<!-- Sidebar -->
    <div id="sidebar" class="d-flex flex-column flex-shrink-0 p-3 bg-light vh-100" style="width: 280px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="mb-3"><a href="/pesan_pelapor" id="list-2" class="nav-link link-dark"><i id="icon2" class="fa-solid fa-envelope-circle-check fa-lg"></i><span id="text2" class="sidebar-text ms-3">Pesan</span></a></li>
        ...
        <li class="mb-3"><a href="/dashboard-admin" id="list-1" class="nav-link link-dark"><i id="icon1" class="fa-solid fa-database fa-lg "></i><span id="text1" class="sidebar-text ms-3">Dashboard</span></a></li>
        <li class="mb-3"><a href="/pesan-masuk" id="list-2" class="nav-link link-dark"><i id="icon2" class="fa-solid fa-envelope fa-lg "></i><span id="text2" class="sidebar-text ms-3">Pesan dari Pelapor</span></a></li>
        <li class="mb-3"><a href="/pesan-masuk-upt" id="list-2" class="nav-link link-dark"><i id="icon2" class="fa-solid fa-envelope fa-lg "></i><span id="text2" class="sidebar-text ms-3">Pesan dari UPT</span></a></li>
        <li class="mb-3"><a href="/pesan" id="list-2" class="nav-link link-dark"><i id="icon2" class="fa-solid fa-envelope-circle-check fa-lg"></i><span id="text2" class="sidebar-text ms-3">Pesan</span></a></li>
        <li class="mb-3"><a href="/pesan-keluar" id="list-3" class="nav-link link-dark"><i id="icon3" class="fa-solid fa-envelope-open fa-lg "></i><span id="text3" class="sidebar-text ms-3">Pesan Keluar</span></a></li>
        @endif
